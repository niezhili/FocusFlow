package com.niezhili.focusflow.data.repository;
...
public class FocusRepository {
    ...
    public Flowable<List<DailyStats>> getDaySessions(long dayStart, long dayEnd) {
        return focusSessionDao.getDaySessions(dayStart, dayEnd).subscribeOn(Schedulers.io());
    }
