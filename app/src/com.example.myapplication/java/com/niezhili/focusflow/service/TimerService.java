package com.niezhili.focusflow.service;
...
import com.niezhili.focusflow.FocusFlowApp;
import com.niezhili.focusflow.R;
...
public class TimerService extends Service {
    ...
    private void playStartAlert() {
        UserPreferences prefs = ((FocusFlowApp) getApplication()).getUserPreferences();

        prefs.getSound().subscribe(sound -> {
        ...
        }, throwable -> { /* DataStore read failed, use defaults */ });

        prefs.isVibrationEnabled().subscribe(enabled -> {
            if (enabled) {
