...
import com.niezhili.focusflow.ui.MainScreen
import com.niezhili.focusflow.ui.theme.FocusFlowTheme
import com.niezhili.focusflow.ui.theme.ThemeMode
...
fun ComponentActivity.setFocusFlowContent() {
    setContent {
        ...
        val userPreferences = remember { (context.applicationContext as FocusFlowApp).userPreferences }
